...
function(a) {
    ...
    a('#navbar-main li.nav-item a.nav-link, .js-scroll').on('click', function(c) {
        let b = this.hash;
    ...
    function k(c) {
        ...
        case 1:
            ...
            window.matchMedia('(prefers-color-scheme: dark)').matches ? a = !0 : window.matchMedia('(prefers-color-scheme: light)').matches ? a = !1 : a = isSiteThemeDark,
    ...
    function h(c, b=!1) {
        ...
        if (!b)
            if (c === !1 && !a('body').hasClass('dark') || c === !0 && a('body').hasClass('dark'))
                return;
        c === !1 ? (b || a('body').css({
            opacity: 0,
            visibility: 'visible'
        ...
        g && (b ? mermaid.initialize({
            theme: 'default',
            securityLevel: 'loose'
        }) : location.reload())) : c === !0 && (b || a('body').css({
            opacity: 0,
            visibility: 'visible'
        }).animate({
            opacity: 1
    ...
    a(document).ready(function() {
        ...
        b.addListener(b=>{
            ...
            d === 2 && (window.matchMedia('(prefers-color-scheme: dark)').matches ? a = !0 : window.matchMedia('(prefers-color-scheme: light)').matches ? a = !1 : a = isSiteThemeDark,
            h(a))
        }
        )
    }),
